...
public class DataMsg extends net.tinyos.message.Message {
    ...
    /** Create a new DataMsg of size 18. */
    public DataMsg() {
    ...
    public String toString() {
      ...
      try {
        s += "  [member_TOS_NODE_ID=0x"+Long.toHexString(get_member_TOS_NODE_ID())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    }
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: member_TOS_NODE_ID
    //   Field type: int, unsigned
    //   Offset (bits): 128
    //   Size (bits): 16
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'member_TOS_NODE_ID' is signed (false).
     */
    public static boolean isSigned_member_TOS_NODE_ID() {
        return false;
    }

    /**
     * Return whether the field 'member_TOS_NODE_ID' is an array (false).
     */
    public static boolean isArray_member_TOS_NODE_ID() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'member_TOS_NODE_ID'
     */
    public static int offset_member_TOS_NODE_ID() {
        return (128 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'member_TOS_NODE_ID'
     */
    public static int offsetBits_member_TOS_NODE_ID() {
        return 128;
    }

    /**
     * Return the value (as a int) of the field 'member_TOS_NODE_ID'
     */
    public int get_member_TOS_NODE_ID() {
        return (int)getUIntBEElement(offsetBits_member_TOS_NODE_ID(), 16);
    }

    /**
     * Set the value of the field 'member_TOS_NODE_ID'
     */
    public void set_member_TOS_NODE_ID(int value) {
        setUIntBEElement(offsetBits_member_TOS_NODE_ID(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'member_TOS_NODE_ID'
     */
    public static int size_member_TOS_NODE_ID() {
        return (16 / 8);
    }

    /**
     * Return the size, in bits, of the field 'member_TOS_NODE_ID'
     */
    public static int sizeBits_member_TOS_NODE_ID() {
        return 16;
    }
